...
- Data retrieved from Google APIs is processed locally on infrastructure controlled by the account owner.
- No data is sold, shared, or transmitted to any third party.
- No data is used for advertising or analytics purposes.

## Data retention

Data is retained only as long as needed to perform the requested action, or as cached locally by the account owner's own tooling for their own convenience.
...
For questions about this policy, contact: robobobushka@gmail.com
